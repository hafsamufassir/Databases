...
SELECT department, COUNT(employees) FROM employees GROUP BY department HAVING COUNT(employees) > 2;
...
UPDATE departments SET budget = budget * 0.9
  WHERE budget = (SELECT budget FROM departments ORDER BY budget ASC LIMIT 1);
